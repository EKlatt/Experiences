...
#define ARDUINOLCDI2C      //changed Enno
...
#undef ARDUINOETH
#undef ARDUINOMQTT
#undef ARDUINOSENSORS      //changed Enno
#undef ARDUINOSPIRAM 
#undef STANDALONE
...
#undef DISPLAYHASCOLOR
#undef DISPLAYHASGRAPH
const int dsp_rows=2;         //changed Enno
const int dsp_columns=16;     //changed Enno
